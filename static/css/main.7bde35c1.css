...
:root {
    ...
    --brand-hover: #ef4444cc;
    --brand-active: #ef444499;
    --brand-secondary: #dc2626;
    --border-light: #ffffff1a;
    --border-medium: #fff3;
    --border-strong: #ffffff4d;
    --background: 0 0% 100%;
    --foreground: 0 0% 3.9%;
    --card: 0 0% 100%;
...
.hover\:bg-\[\#20BA5A\]:hover {
    ...
    background-color: rgb(32 186 90/var(--tw-bg-opacity, 1))
}
...
.group:hover .group-hover\:bg-\[\#ef4444\]\/20 {
...
/*# sourceMappingURL=main.7bde35c1.css.map*/